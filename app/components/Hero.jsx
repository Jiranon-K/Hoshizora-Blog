    ...
    <div className="relative w-full h-[45vh] min-h-[600px] overflow-hidden bg-[#0F1015]">
      ...
      >
        <div
          ...
          style={{
            backgroundImage:
              "repeating-linear-gradient(transparent 0, transparent 24px, rgba(255,255,255,0.1) 24px, rgba(255,255,255,0.1) 25px)",
            opacity: 0.3,
          }}
        ></div>
      </HeroBackground>
      ...
      <div className="relative z-10 w-full h-full flex items-center px-8 lg:px-16">
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <HeroContent className="space-y-6 text-white">
            <HeroBadge className="flex items-center space-x-4">
            ...
            <HeroDescription className="relative group">
              <div
                className="absolute -inset-4 bg-black/80 rounded-xl -z-10 
            ...
            <HeroCTA className="flex items-center space-x-4">
              ...
              <div className="relative group">
                ...
                ></div>
                <div
                  className="relative z-10 bg-white/20 px-4 py-2 rounded-full 
                                text-sm text-white
                                transition-all duration-300
