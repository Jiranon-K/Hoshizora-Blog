...
import {
  ...
  BlogGridItem,
  BlogGridHeader,
} from "./motion/BlogGridAnimations";
  ...
  return (
    <div className="mb-12 border-b border-zinc-800 pb-4">
      <div className="flex flex-wrap items-center gap-6">
        <Link href="?">
          <span
            className={`text-sm tracking-wide transition-colors duration-300 cursor-pointer pb-4 border-b-2 
            ${
              !currentCategory
    ...
    <div className="min-h-screen bg-black text-white">
      <div className="w-full py-16 px-4 md:px-6 lg:px-8 relative z-10">
        <div className="mx-auto max-w-screen-xl">
          <BlogGridHeader className="flex flex-col items-start mb-16">
          ...
          {posts.length > 0 ? (
            <BlogGridContainer className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {posts.map((post) => (
